...
if ( ! class_exists( 'Envince_Admin' ) ) :
	...
	class Envince_Admin {
		...
		public function admin_menu() {
			...
			$page = add_theme_page(
				esc_html__( 'About', 'envince' ) . ' ' . $theme->display( 'Name' ),
				esc_html__( 'About', 'envince' ) . ' ' . $theme->display( 'Name' ),
				'activate_plugins',
				'envince-welcome',
				array(
		...
		public function enqueue_styles() {
			...
			wp_enqueue_style( 'envince-welcome', get_template_directory_uri() . '/css/admin/welcome.css', array(), ENVINCE_THEME_VERSION );
		}
		...
		private function intro() {
			...
			$major_version = substr( ENVINCE_THEME_VERSION, 0, 3 );
			?>
			...
			<p class="envince-actions">
				<a href="<?php echo esc_url( 'https://themegrill.com/themes/envince/?utm_source=envince-about&utm_medium=theme-info-link&utm_campaign=theme-info' ); ?>" class="button button-secondary" target="_blank"><?php esc_html_e( 'Theme Info', 'envince' ); ?></a>
			...
			<h2 class="nav-tab-wrapper">
				<a class="nav-tab
				<?php
				if ( empty( $_GET['tab'] ) && $_GET['page'] == 'envince-welcome' ) {
					echo 'nav-tab-active';
				}
				?>
				" href="<?php echo esc_url( admin_url( add_query_arg( array( 'page' => 'envince-welcome' ), 'themes.php' ) ) ); ?>">
					<?php echo $theme->display( 'Name' ); ?>
				</a>
				<a class="nav-tab
				<?php
				...
				<div class="changelog point-releases">
					<div class="under-the-hood two-col">
						<div class="col">
							...
							<p>
								<a href="<?php echo admin_url( 'customize.php' ); ?>" class="button button-secondary"><?php esc_html_e( 'Customize', 'envince' ); ?></a>
							</p>
						</div>
						...
						<div class="col">
							...
							<p>
								<a href="<?php echo esc_url( 'https://docs.themegrill.com/envince/?utm_source=envince-about&utm_medium=documentation-link&utm_campaign=documentation' ); ?>" class="button button-secondary" target="_blank"><?php esc_html_e( 'Documentation', 'envince' ); ?></a>
							</p>
						</div>
						...
						<div class="col">
							...
							<p>
								<a href="<?php echo esc_url( 'https://themegrill.com/support-forum/?utm_source=envince-about&utm_medium=support-forum-link&utm_campaign=support-forum' ); ?>" class="button button-secondary" target="_blank"><?php esc_html_e( 'Support Forum', 'envince' ); ?></a>
							</p>
						</div>
						...
						<div class="col">
							...
							<p>
								<a href="<?php echo esc_url( 'https://themegrill.com/contact/?utm_source=envince-about&utm_medium=contact-page-link&utm_campaign=contact-page' ); ?>" class="button button-secondary" target="_blank"><?php esc_html_e( 'Contact Page', 'envince' ); ?></a>
							</p>
						</div>
		...
		public function supported_plugins_screen() {
			...
			<div class="wrap about-wrap">
				...
				<ol>
					<li>
						<a href="<?php echo esc_url( 'https://wordpress.org/plugins/social-icons/' ); ?>" target="_blank"><?php esc_html_e( 'Social Icons', 'envince' ); ?></a>
						<?php esc_html_e( ' by ThemeGrill', 'envince' ); ?>
					</li>
					<li>
						<a href="<?php echo esc_url( 'https://wordpress.org/plugins/easy-social-sharing/' ); ?>" target="_blank"><?php esc_html_e( 'Easy Social Sharing', 'envince' ); ?></a>
						<?php esc_html_e( ' by ThemeGrill', 'envince' ); ?>
					</li>
					<li>
						<a href="<?php echo esc_url( 'https://wordpress.org/plugins/contact-form-7/' ); ?>" target="_blank"><?php esc_html_e( 'Contact Form 7', 'envince' ); ?></a>
					</li>
					<li>
						<a href="<?php echo esc_url( 'https://wordpress.org/plugins/siteorigin-panels/' ); ?>" target="_blank"><?php esc_html_e( 'Page Builder by SiteOrigin', 'envince' ); ?></a>
					</li>
					</li>
					<li>
						<a href="<?php echo esc_url( 'https://wpml.org/' ); ?>" target="_blank"><?php esc_html_e( 'WPML', 'envince' ); ?></a>
