...
class Envince_Theme_Review_Notice {
	...
	public function __construct() {
		...
		add_action( 'admin_enqueue_scripts', array( $this, 'envince_theme_review_notice_enqueue' ) );
	...
	public function envince_theme_review_notice() {
		...
		<div class="notice updated theme-review-notice" style="position:relative;">
			...
			<div class="links">
				<a href="https://wordpress.org/support/theme/envince/reviews/?filter=5#new-post" class="btn
				button-primary"
				   target="_blank">
				...
				<a href="<?php echo esc_url( 'https://wordpress.org/support/theme/envince/' ); ?>" class="btn
			...
			<a class="notice-dismiss" style="text-decoration:none;"
			   href="?nag_envince_ignore_theme_review_notice=0"></a>
		</div>
	 ...
	 */
	public function envince_theme_review_notice_enqueue() {
