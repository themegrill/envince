...
/**
 * Envince_Demo_Importer Class.
 */
class Envince_Demo_Importer {
	...
	public function __construct() {
		$this->plugin_data = array(
			...
			'name' => __( 'ThemeGrill Demo importer', 'envince' ),
		);
	...
	public function add_admin_menu() {
		add_theme_page( __( 'Demo Importer', 'envince' ), __( 'Demo Importer', 'envince' ), 'switch_themes', 'demo-importer', array( $this, 'demo_importer' ) );
	}
